...
//		Collections.sort(outcomeNum);
		...
		List<Integer> outcomeNum = new ArrayList<>(Arrays.asList(2,4,6,8,10,12));
		int bonusNum = 7;
...
//					
			...
			if (count == 5 && bonusChk) { // 이건 2등
				ImageIcon tmp = new ImageIcon("Score/2nd.gif");
				...
				case 6:
					...
					break;
				case 5:
					ImageIcon tmp2 = new ImageIcon("Score/3rd.gif");

...
class SelectingNumber extends JFrame {
	 ...
	 * 구매하기 버튼 A XXXXXXX 자동 수정 삭제 장당 1,000 B XXXXXXX 자동 수정 삭제 >> 번 호 >> 총 금액 : C
	 * XXXXXXX 자동 수정 삭제 D XXXXXXX 자동 수정 삭제 반자동 초기화 확인 구매하기
	 */
	...
	String[] editOfButton = { "자동", "수정", "삭제" }; // 자동 수정 삭제 버튼
...
//		int cnt = ?
		...
		numOfLottery.get(0).addMouseListener(new MouseAdapter() {
			@Override
